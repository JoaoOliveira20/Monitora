...
npm test
# OK — 20 testes passaram (tsx --test "tests/**/*.test.ts"): 3 de src/index.ts (incluindo a regressão do bug
# de MONITOR_NAME vazio), 12 de src/config/schema.ts, 5 de src/config/loader.ts.
